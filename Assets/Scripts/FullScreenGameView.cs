...
public static class FullscreenGameView
{
    ...
    [MenuItem("Window/General/Game (Fullscreen) #F7", priority = 2)]
    public static void Toggle()
    {
        ...
        else
        {
            ...
            Vector2 screenSizeReal = new Vector2(Screen.currentResolution.width, Screen.currentResolution.height) / (Screen.dpi / 96f);

            var desktopResolution = screenSizeReal;
